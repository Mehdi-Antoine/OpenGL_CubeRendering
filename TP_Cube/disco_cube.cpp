...
struct MyProgram {
    ...
    MyProgram(const FilePath& applicationPath):
        m_Program(loadProgram(applicationPath.dirPath() + "shaders/3Dtest3.vs.glsl",
                              applicationPath.dirPath() + "shaders/LightTex.fs.glsl",
                              applicationPath.dirPath() + "shaders/CubeNormalTex.gs.glsl")) {
...
//--------------------------------------------------------------------------------------------------
    ...
    std::unique_ptr<Image> textureSting = loadImage("/home/mehdi/Documents/synthese/GLImac-Template/assets/textures/sting.jpg");
...
//--------------------------------------------------------------------------------------------------
    ...
    for(int k=0; k < TAILLE * TAILLE; ++k){
        ...
        //cube_color[k]    = glm::vec3(0.01, 1, 0.01);
    }
...
//--------------------------------------------------------------------------------------------------
    ...
    while(!done){
        ...
        //GESTION LIGHT
        lightPos = glm::vec3(glm::vec4(-3, 10, -3, 1));
        ...
        glUniform3f(program.uKd, 1, 1, 1);
        glUniform3f(program.uKs, 1, 1, 1);
        glUniform1f(program.uShininess, 5);

        glUniform3f(program.uLightIntensity, 40, 40, 40);
