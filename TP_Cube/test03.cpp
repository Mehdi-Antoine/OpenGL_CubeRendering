...
struct MyProgram {
    ...
    MyProgram(const FilePath& applicationPath):
        m_Program(loadProgram(applicationPath.dirPath() + "shaders/3Dtest3.vs.glsl",
                              applicationPath.dirPath() + "shaders/3Dtest3.fs.glsl",
                              applicationPath.dirPath() + "shaders/Carre.gs.glsl")) {
...
//--------------------------------------------------------------------------------------------------
    ...
    for(int k=0; k < TAILLE * TAILLE; ++k){
        ...
        float r = (float)(k/TAILLE + 3)/(TAILLE+10);
        float v = (float)(k%TAILLE)/(TAILLE+10);
        float b = (float)(k/TAILLE+k%TAILLE)/((TAILLE+10)*2);

        cube_color[k]    = glm::vec3(r, v, b);
    }
...
//--------------------------------------------------------------------------------------------------
    ...
    while(!done){
        ...
        VMatrix = freefly? freeflyCamera.getViewMatrix() : trackballCamera.getViewMatrix();
